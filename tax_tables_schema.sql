...
-- Stores income input data only - tax calculations are computed on-the-fly
...
-- Table: tax_calculation_details (DEPRECATED - NOT USED)
-- This table is no longer used. Tax calculations are computed on-the-fly.
-- Commented out to prevent creation in new installations.
...
SELECT 'Tax calculation table created successfully!' AS status;
SHOW TABLES LIKE 'tax_calculations';
