...
# ==================================================
# USER ROUTES - Registered from services/user_service.py
# ==================================================
# All user authentication and profile routes are now handled by the user_service
# This reduces the size of app.py and improves code organization
# Routes include: /register, /login, /logout, /api/change-password,
# /api/user-preferences, /api/auth/token, /api/auth/token/revoke
...
# ==================================================
# Token generation and revocation routes are now handled by user_service.py
# Note: token_required decorator wraps the revoke_token route in user_service.py
