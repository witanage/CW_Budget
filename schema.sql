...
-- ============================================================
-- Exchange Rate Trends View
-- ============================================================
-- Pre-aggregates daily exchange rates into weekly and monthly
-- summaries across all sources, with moving averages and
-- volatility metrics for trend analysis and forecasting.
-- ============================================================

-- Daily summary across all sources (picks best available rate per day)
CREATE OR REPLACE VIEW v_exchange_rate_daily AS
SELECT
    date,
...
CREATE OR REPLACE VIEW v_exchange_rate_weekly AS
SELECT
...
CREATE OR REPLACE VIEW v_exchange_rate_monthly AS
SELECT
    YEAR(date)               AS year,
    MONTH(date)              AS month,
...
-- Source comparison view (compare rates across banks for same date)
CREATE OR REPLACE VIEW v_exchange_rate_source_comparison AS
SELECT
    date,
    source,
    buy_rate,
