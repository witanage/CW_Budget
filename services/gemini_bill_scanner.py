...
2. Total Amount: The final total amount to be paid
...
"""
            ...
            if is_pdf:
                ...
                file_part = Part.from_bytes(data=image_data, mime_type="application/pdf")
                response = self.client.models.generate_content(model=self.model_name, contents=[prompt, file_part])
            else:
